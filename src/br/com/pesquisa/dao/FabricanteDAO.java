...
import br.com.pesquisa.factory.ConexaoFactory;
...
public class FabricanteDAO {
	...
	public static void main(String[] args) {
		 ...
		 * (SQLException e) {
		 * System.out.println("Não foi possível remover os fabricantes!");
		 * e.printStackTrace(); }
		 */

		/*
		 * Fabricante f1 = new Fabricante(); f1.setCodigo(4L);
		 * f1.setDescricao("DESCRIÇÃO 4");
		 * 
		 ...
		 * 
		 * Fabricante f2 = new Fabricante(); f2.setCodigo(7L);
		 * 
		 * FabricanteDAO fdao = new FabricanteDAO();
		 * 
		 ...
		 * 
		 * System.out.println("Resultado 1: " + f3); System.out.println("Resultao  2: "
